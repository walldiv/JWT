...
import com.ex.jwt.jwt.filter.JwtAccessDeniedHandler;
import com.ex.jwt.jwt.filter.JwtAuthenticationEntryPoint;
import com.ex.jwt.jwt.filter.JwtAuthorizationFilter;
...
import static com.ex.jwt.jwt.config.SecurityConstants.PUBLIC_URLS;
